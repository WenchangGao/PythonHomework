...
class Preprocessor:
    ...
    def tokenize_data(self):
        ...
        self.sequenced_titles = sequence.pad_sequences(title_ids)
        self.sequenced_summaries = sequence.pad_sequences(summaries_ids)
        print(self.sequenced_summaries)
        print(self.sequenced_summaries.shape)
